...
Using this Starter Repository and VSCode.dev edit the main.js file to allow for the following:

* When the user clicks on the ON button
  * the image will change sources to the "on.png" image.
  * the background of the division that holds the image will change to the `--light-clr` CSS variable
